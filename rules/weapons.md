...
All weapons in D&D are the same. The only way to get better versions is to acquire magical versions with +1, +2, or +3 bonuses, or with extra magical damage, often fire.
...
Using the new weapon properties you can create different custom weapons, these weapons can do increased damage due to their improved quality.

One way to increase the damage of these improved weapons is by given them larger damage dice than the standard version.
For instance, a superheavy waraxe could have 2d8 instead of 1d8, or an elegant dagger deals 1d8 instead of 1d4.
Let your creativity go wild.

Generally, the table below shows what ability score requirement merits what level of damage.
